 ...
 * @author jluis
 */
public class ListadeGastosResi extends javax.swing.JPanel {
    String Fechain;
    String FechaFin;
    Double SUMATOTAL;
    ...
    private void ListarGastos() {
        ...
        ArrayList<InsertarProducto> result = BDGastosResi.ListarGastos(Fechain, FechaFin);
    ...
    private void generar() {
        try {
            ...
            FECHAFINs = df.format(Fecha2.getDate());
                ...
                JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile("C:\\Reportes\\ANGELS\\ResumenGastosResidenciales.jasper");
