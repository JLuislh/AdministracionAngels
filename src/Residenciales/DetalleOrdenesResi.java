 ...
 * @author jluis
 */
public class DetalleOrdenesResi extends javax.swing.JPanel {
    String Fecha;
    int orden;
    int cantidadOrdenes;
    /**
    ...
    private void OrdenesDiaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OrdenesDiaMouseClicked
     ...
     private void ListarOrdenesPedidas(){
        ...
        ArrayList<InsertarProducto> result = BDOrdenes.DetalleOrdenesResi(orden);
        Pedido(result);  
    }
