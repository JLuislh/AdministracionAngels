 ...
 * @author jluis
 */
public class AdProductosInventarioBebidasResi extends javax.swing.JPanel {

    /**
     * Creates new form ProductosInventario
     */
    public AdProductosInventarioBebidasResi() {
        initComponents();
   ...
   private void imprimir(){
    ...
    private void ListarProductosInventario(){
        ...
        ArrayList<InsertarProducto> result = BDIngresosResi.BDIngresosProductosInventarioBebidas();
     ...
     try {
            ...
            BDProductosResi.InsertarProductoIngresoInventario(p);
     ...
     int id = (int) (ProInventario.getModel().getValueAt(ProInventario.getSelectedRow(), 0));
        ArrayList<InsertarProducto> result = BDIngresosResi.ListadeIngresos(id);
        Tabla(result);  
    }
