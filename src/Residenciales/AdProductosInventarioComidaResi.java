 ...
 * @author jluis
 */
public class AdProductosInventarioComidaResi extends javax.swing.JPanel {
    int estado;
    /**
     * Creates new form ProductosInventario
     */
    public AdProductosInventarioComidaResi() {
        initComponents();
    ...
    private void ListarProductosInventario(){
        ...
        ArrayList<InsertarProducto> result = BDIngresosResi.BDIngresosProductosInventarioComida();
