 ...
 * @author jluis
 */
public class AdDescargasInventarioResi extends javax.swing.JPanel {
     ...
     */
    public AdDescargasInventarioResi() {
        initComponents();
    ...
    private void limpiar(){
     ...
     private void ListarProductosInventario(){
        ...
        ArrayList<InsertarProducto> result = BDIngresosResi.ListarProductosVenta();
     ...
     private void ListarProductosDescarga(){
        ...
        ArrayList<InsertarProducto> result = BDIngresosResi.ListarProductosDescargasVentas(codigo);
     ...
     private void RecargarTablaDesc(ArrayList<InsertarProducto> list) {
      ...
      private void ListarInventario(){
       // int codigo = (int) (Producto.getModel().getValueAt(Producto.getSelectedRow(), 0));
        ArrayList<InsertarProducto> result = BDIngresosResi.ProductosInventario();
     ...
     try {
            ...
            BDProductosResi.InsertarProductoDescargaInventario(p);
