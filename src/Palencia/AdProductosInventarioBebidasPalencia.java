 ...
 * @author jluis
 */
public class AdProductosInventarioBebidasPalencia extends javax.swing.JPanel {

    /**
     * Creates new form ProductosInventario
     */
    public AdProductosInventarioBebidasPalencia() {
        initComponents();
   ...
   private void imprimir(){
    ...
    private void ListarProductosInventario(){
        ...
        ArrayList<InsertarProducto> result = BDIngresosPalencia.BDIngresosProductosInventarioBebidas();
     ...
     try {
            ...
            BDProductosPalencia.InsertarProductoIngresoInventario(p);
     ...
     int id = (int) (ProInventario.getModel().getValueAt(ProInventario.getSelectedRow(), 0));
        ArrayList<InsertarProducto> result = BDIngresosPalencia.ListadeIngresos(id);
        Tabla(result);  
    }
