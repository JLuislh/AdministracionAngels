 ...
 * @author jluis
 */
public class DetalleOrdenesPalencia extends javax.swing.JPanel {
    String Fecha;
    int orden;
    int cantidadOrdenes;
    /**
    ...
    private void OrdenesDiaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OrdenesDiaMouseClicked
     ...
     private void ListarOrdenesPedidas(){
        ...
        ArrayList<InsertarProducto> result = BDOrdenes.DetalleOrdenesPalencia(orden);
        Pedido(result);  
    }
