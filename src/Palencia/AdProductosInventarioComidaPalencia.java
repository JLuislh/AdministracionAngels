 ...
 * @author jluis
 */
public class AdProductosInventarioComidaPalencia extends javax.swing.JPanel {
    int estado;
    /**
     * Creates new form ProductosInventario
     */
    public AdProductosInventarioComidaPalencia() {
        initComponents();
    ...
    private void ListarProductosInventario(){
        ...
        ArrayList<InsertarProducto> result = BDIngresosPalencia.BDIngresosProductosInventarioComida();
