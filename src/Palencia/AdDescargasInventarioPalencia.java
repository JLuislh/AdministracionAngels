 ...
 * @author jluis
 */
public class AdDescargasInventarioPalencia extends javax.swing.JPanel {
     ...
     */
    public AdDescargasInventarioPalencia() {
        initComponents();
    ...
    private void limpiar(){
     ...
     private void ListarProductosInventario(){
        ...
        ArrayList<InsertarProducto> result = BDIngresosPalencia.ListarProductosVenta();
     ...
     private void ListarProductosDescarga(){
        ...
        ArrayList<InsertarProducto> result = BDIngresosPalencia.ListarProductosDescargasVentas(codigo);
     ...
     private void RecargarTablaDesc(ArrayList<InsertarProducto> list) {
      ...
      private void ListarInventario(){
       // int codigo = (int) (Producto.getModel().getValueAt(Producto.getSelectedRow(), 0));
        ArrayList<InsertarProducto> result = BDIngresosPalencia.ProductosInventario();
     ...
     try {
            ...
            BDProductosPalencia.InsertarProductoDescargaInventario(p);
