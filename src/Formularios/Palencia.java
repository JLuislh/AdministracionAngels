...
import Palencia.AdDescargasInventarioPalencia;
import Palencia.AdProductosInventarioBebidasPalencia;
import Palencia.AdProductosInventarioComidaPalencia;
import Palencia.AdTotalEnCajaPalencia;
import Palencia.DetalleOrdenesPalencia;
import Palencia.GastosPalencia;
import Palencia.ListadeGastosPalencia;
import Palencia.ReporteMensualPalencia;
import Palencia.ReportedeVentas;
 ...
 * @author jluis
 */
public class Palencia extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        PanelPalencia = new javax.swing.JPanel();
        ...
        PanelPalencia.setPreferredSize(new java.awt.Dimension(1270, 528));

        javax.swing.GroupLayout PanelPalenciaLayout = new javax.swing.GroupLayout(PanelPalencia);
        PanelPalencia.setLayout(PanelPalenciaLayout);
        PanelPalenciaLayout.setHorizontalGroup(
            PanelPalenciaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 0, Short.MAX_VALUE)
        );
        PanelPalenciaLayout.setVerticalGroup(
            PanelPalenciaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(PanelPalencia, javax.swing.GroupLayout.DEFAULT_SIZE, 1320, Short.MAX_VALUE)
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(panelRound9, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(PanelPalencia, javax.swing.GroupLayout.DEFAULT_SIZE, 572, Short.MAX_VALUE))
        );
    ...
    AdTotalEnCajaPalencia op2 = new AdTotalEnCajaPalencia();
    op2.setSize(1124, 496);
    op2.setLocation(0, 0);
    PanelPalencia.removeAll();
    PanelPalencia.add(op2,BorderLayout.CENTER);
    PanelPalencia.revalidate();
    PanelPalencia.repaint();
    }//GEN-LAST:event_jLabel2MousePressed

    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
    DetalleOrdenesPalencia op2 = new DetalleOrdenesPalencia();
    ...
    AdDescargasInventarioPalencia op2 = new AdDescargasInventarioPalencia();
    op2.setSize(1124, 572);
    op2.setLocation(0, 0);
    PanelPalencia.removeAll();
    PanelPalencia.add(op2,BorderLayout.CENTER);
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        ListadeGastosPalencia op2 = new ListadeGastosPalencia();
        op2.setSize(1124, 496);
        op2.setLocation(0, 0);
        PanelPalencia.removeAll();
        PanelPalencia.add(op2,BorderLayout.CENTER);
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
      GastosPalencia op2 = new GastosPalencia();
        op2.setSize(1124, 496);
        op2.setLocation(0, 0);
        PanelPalencia.removeAll();
        PanelPalencia.add(op2,BorderLayout.CENTER);
    ...
    ReporteMensualPalencia op2 = new ReporteMensualPalencia();
        op2.setSize(1124, 572);
        op2.setLocation(0, 0);
        PanelPalencia.removeAll();
        PanelPalencia.add(op2,BorderLayout.CENTER);
    ...
    AdProductosInventarioComidaPalencia op2 = new AdProductosInventarioComidaPalencia();
    op2.setSize(1124, 572);
    op2.setLocation(0, 0);
    PanelPalencia.removeAll();
    PanelPalencia.add(op2,BorderLayout.CENTER);
    ...
    AdProductosInventarioBebidasPalencia op2 = new AdProductosInventarioBebidasPalencia();
    op2.setSize(1124, 572);
    op2.setLocation(0, 0);
    PanelPalencia.removeAll();
    PanelPalencia.add(op2,BorderLayout.CENTER);
    ...
    private javax.swing.JPanel PanelPalencia;
