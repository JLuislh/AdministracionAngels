...
import Residenciales.AdDescargasInventarioResi;
import Residenciales.AdProductosInventarioBebidasResi;
import Residenciales.AdProductosInventarioComidaResi;
import Residenciales.AdTotalEnCajaResi;
import Residenciales.DetalleOrdenesResi;
import Residenciales.GastosResi;
import Residenciales.ListadeGastosResi;
import Residenciales.ReporteMensualResi;
import Residenciales.ReportedeVentas;
 ...
 * @author jluis
 */
public class Residenciales extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        PanelResidenciales = new javax.swing.JPanel();
        ...
        PanelResidenciales.setPreferredSize(new java.awt.Dimension(1270, 528));

        javax.swing.GroupLayout PanelResidencialesLayout = new javax.swing.GroupLayout(PanelResidenciales);
        PanelResidenciales.setLayout(PanelResidencialesLayout);
        PanelResidencialesLayout.setHorizontalGroup(
            PanelResidencialesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 0, Short.MAX_VALUE)
        );
        PanelResidencialesLayout.setVerticalGroup(
            PanelResidencialesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(PanelResidenciales, javax.swing.GroupLayout.DEFAULT_SIZE, 1320, Short.MAX_VALUE)
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(panelRound9, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(PanelResidenciales, javax.swing.GroupLayout.DEFAULT_SIZE, 572, Short.MAX_VALUE))
        );
    ...
    private void jLabel2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MousePressed
        AdTotalEnCajaResi op2 = new AdTotalEnCajaResi();
    op2.setSize(1124, 496);
    op2.setLocation(0, 0);
    PanelResidenciales.removeAll();
    PanelResidenciales.add(op2,BorderLayout.CENTER);
    PanelResidenciales.revalidate();
    PanelResidenciales.repaint();
    }//GEN-LAST:event_jLabel2MousePressed

    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
    DetalleOrdenesResi op2 = new DetalleOrdenesResi();
    ...
    AdDescargasInventarioResi op2 = new AdDescargasInventarioResi();
    op2.setSize(1124, 572);
    op2.setLocation(0, 0);
    PanelResidenciales.removeAll();
    PanelResidenciales.add(op2,BorderLayout.CENTER);
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        ListadeGastosResi op2 = new ListadeGastosResi();
        op2.setSize(1124, 496);
        op2.setLocation(0, 0);
        PanelResidenciales.removeAll();
        PanelResidenciales.add(op2,BorderLayout.CENTER);
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
        ReporteMensualResi op2 = new ReporteMensualResi();
        op2.setSize(1124, 572);
        op2.setLocation(0, 0);
        PanelResidenciales.removeAll();
        PanelResidenciales.add(op2,BorderLayout.CENTER);
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
     AdProductosInventarioComidaResi op2 = new AdProductosInventarioComidaResi();
    op2.setSize(1124, 572);
    op2.setLocation(0, 0);
    PanelResidenciales.removeAll();
    PanelResidenciales.add(op2,BorderLayout.CENTER);
    ...
    AdProductosInventarioBebidasResi op2 = new AdProductosInventarioBebidasResi();
    op2.setSize(1124, 572);
    op2.setLocation(0, 0);
    PanelResidenciales.removeAll();
    PanelResidenciales.add(op2,BorderLayout.CENTER);
    ...
    private javax.swing.JPanel PanelResidenciales;
