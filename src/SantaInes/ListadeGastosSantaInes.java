 ...
 * @author jluis
 */
public class ListadeGastosSantaInes extends javax.swing.JPanel {
    String Fechain;
    String FechaFin;
    Double SUMATOTAL;
    String FECHAINs;
    ...
    private void generar() {
        try {
            ...
            FECHAFINs = df.format(Fecha2.getDate());
                ...
                JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile("C:\\Reportes\\ANGELS\\ResumenGastosSantaInes.jasper");
