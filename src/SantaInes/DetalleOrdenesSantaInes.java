 ...
 * @author jluis
 */
public class DetalleOrdenesSantaInes extends javax.swing.JPanel {
    String Fecha;
    int orden;
    int cantidadOrdenes;
    /**
     ...
     */
    public DetalleOrdenesSantaInes() {
        initComponents();
    }
    ...
    private void ListarOrdenes(){
     ...
     private void ListarOrdenesPedidas(){
        ...
        ArrayList<InsertarProducto> result = BDOrdenes.DetalleOrdenesSantaInes(orden);
        Pedido(result);  
    }
