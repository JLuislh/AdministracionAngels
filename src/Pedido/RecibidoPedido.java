 ...
 * @author it
 */
public class RecibidoPedido extends javax.swing.JPanel {
    String Fecha;
    int id_pedido;
    int id_producto;
    int id_productoin;
     ...
     try {
      ...
      private void Buscarinformacion() {
       try {
            ...
            ClassProductos c = BDIngresosConsultas.buscarProductoRecibido(id_pedido,id_productoin);
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        ...
        actualizarCantidadRecibida();}else{JOptionPane.showMessageDialog(null, "SELECCIONAR UN PRODUCTO...");}
